...
<head>
    ...
    <link rel="stylesheet" href="STYLES/shipped_style.css">
        ...
        <div class="main_header_cont">
            <div class="logo_cont">
                <a href="admin_side.php" class="dp">
                    <p><span class="D">DISENYO</span><span class="P">PILIPINO</span><span class="page_name">Shipped Orders</span></p>
                </a>
            </div>
            <div class="nav_cnt">
                ...
                echo "
                    <div class='prdct_cont'>
                        ...
                        <form action='/DP/FUNCTIONS/update_orderstatus.php' method='POST'>
                            ...
                            <button class='shipped_bttn' type='submit'>Delivered</button>
                        </form>
                    </div>
                ";
            }
